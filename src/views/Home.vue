  ...
  onSnapshot(dataQuery,(snapshot)=>{
    ...
    messages.value = posit.value = snapshot.docs.map((doc) => {
      ...
      return {
        ...
        // timestamp:moment(doc.data().timestamp, moment.defaultFormat).format("dddd, MMMM Do YYYY, h:mm:ss a")
        // timestamp:moment(doc.data().timestamp, moment.defaultFormat)
        timestamp:moment(doc.data().timestamp).format('YYYY-MM-DD HH:mm:ss')
        // timestamp:moment(doc.data().timestamp).add(12, 'h').format('YYYY-MM-DD hh:mm:ss')
...
const getPosition = ((position) => {
    ...
    console.log("aposit2.latitude=", aposit.latitude)
    console.log("aposit2.longitude=", aposit.longitude)
